-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('SUPER_ADMIN', 'CONTENT_EDITOR', 'VIEWER');
...
-- CreateIndex
CREATE INDEX "Group_published_idx" ON "Group"("published");

-- CreateIndex
CREATE INDEX "Group_order_idx" ON "Group"("order");

-- CreateIndex
CREATE INDEX "Sermon_published_idx" ON "Sermon"("published");
