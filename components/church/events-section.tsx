...
export function EventsSection({ events, viewAllHref }: EventsSectionProps) {
  return (
    <section
    ...
    >
      <div className="max-w-[var(--container-max)] mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-center gap-6 md:gap-8">
          ...
          {/* Events list — horizontal scroll on mobile, row on desktop */}
          ...
          {viewAllHref && (
            <Link
              href={viewAllHref}
              className="flex-none text-xs font-extrabold uppercase tracking-[0.15em] transition-opacity hover:opacity-70 whitespace-nowrap"
              style={{ color: 'rgba(27, 34, 119, 1)' }}
            >
              View Calendar
            </Link>
